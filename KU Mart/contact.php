	  ...
	  <div class="main_wrapper">
           ...
           <div class="content_wrapper">
				...
				<div id="content_area">
					...
					<div id="products_box">
						<p><h2 style="text-align:center; padding-top:15px;">-Contact us-</h2></p>
						<p><h3 style="text-align:center; padding-top:15px;">Eye</h3></p>
						<p><h4 style="text-align:center; padding-top:15px;">CEO: D-nes- 9847477666</h4></p>
					</div>
